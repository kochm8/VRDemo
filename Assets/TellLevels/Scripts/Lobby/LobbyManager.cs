...
namespace CpvrLab.TellLevels.Scripts
{
        ...
        public class LMAddPlayerMessage : MessageBase
        {
            public string name;
    ...
    public class LobbyManager : NetworkLobbyManager
    {
        ...
        Dictionary<NetworkConnection, GamePlayer> players = new Dictionary<NetworkConnection, GamePlayer>();
            ...
            public override void OnClientSceneChanged(NetworkConnection conn)
            {
                ...
                //<<21.10.16 KOCH MICHAEL, 
                // Playerspawning (ClientScene.AddPlayer) causes errors after loading a new online scene -> Remove and respawn players as a workaround
                // Spawn-Points selection is wrong -> because of numPlayers
                if (conn.playerControllers.Count > 0)
                {
                    //Remove Connection
                    //TODO: Find a better solution...
                    ClientScene.RemovePlayer(conn.playerControllers[0].playerControllerId); // Decreases numPlayers
                    conn.playerControllers.Clear();
                }
                Debug.Log("OnClientSceneChanged::conn.playerControllers = " + conn.playerControllers);
                //KOCH MICHAEL>>
            ...
            */
            public override void OnServerRemovePlayer(NetworkConnection conn, PlayerController player)
            {
                ...
                //21.10.16, KOCH MICHAEL, remove player correctly
                players.Remove(conn);
            }
            /*
            public override void OnServerSceneChanged(string sceneName)
