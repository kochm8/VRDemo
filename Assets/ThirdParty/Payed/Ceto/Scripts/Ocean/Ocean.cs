    ...
    public class Ocean : MonoBehaviour
    {
        ...
        void Start()
        {
			try
			{
                ...
                Shader.SetGlobalTexture(OCEAN_MASK_TEXTURE_NAME, Texture2D.blackTexture);
				Shader.SetGlobalTexture(OCEAN_DEPTH_TEXTURE_NAME, Texture2D.blackTexture);
