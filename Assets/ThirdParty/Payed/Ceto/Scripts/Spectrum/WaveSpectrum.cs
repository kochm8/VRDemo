...
namespace Ceto
{
	...
	public class WaveSpectrum : WaveSpectrumBase
	{
		...
		public override bool DisableReadBack { get { return disableReadBack; } }
		...
		public override float GridScale { get { return gridScale; } }
        ...
        /// </summary>
		public bool IsCreatingNewCondition { get { return m_conditions[1] != null; } }
        ...
        /// Gets the grid sizes.
        /// </summary>
        public override Vector4 GridSizes { get { return m_gridSizes; } }
        Vector4 m_gridSizes = Vector4.one;

        /// <summary>
        /// The choppyness as a vector, one for each grid.
        /// </summary>
		public override Vector4 Choppyness { get { return m_choppyness; } }
		...
		public int MaxConditionCacheSize { set { m_maxConditionCacheSize = value; } }
		...
		{ 
			get 
			{ 
				if(m_displacementBuffer == null) return null;

				if(!(m_displacementBuffer is IDisplacementBuffer))
					throw new InvalidCastException("Displacement buffer cast exception");

				return m_displacementBuffer as IDisplacementBuffer; 
			} 
		}
        ...
        void UpdateQueryScaling()
        {
            ...
            if(m_queryScaling.tmp == null)
                m_queryScaling.tmp = new float[QueryDisplacements.CHANNELS];
		...
		public void CreateAndCacheCondition(int fourierSize, float windSpeed, float windDir, float waveAge)
		{
			...
			if(m_conditionCache.Count >= m_maxConditionCacheSize)
			{
