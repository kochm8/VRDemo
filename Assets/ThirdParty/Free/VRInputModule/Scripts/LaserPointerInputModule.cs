            ...
            foreach (var pair in _controllerData)
            {
                ...
                if (controller.ButtonDown())
                {
                    ...
                    if (data.currentPoint != null)
                    {
                        ...
                        ExecuteEvents.ExecuteHierarchy(data.currentPressed, data.pointerEvent, ExecuteEvents.pointerClickHandler);
                        ExecuteEvents.ExecuteHierarchy(data.currentPressed, data.pointerEvent, ExecuteEvents.pointerDownHandler);
