...
namespace RootMotion.FinalIK {
    ...
    /// <summary>
    /// Copye of FBBIKHeadEffector that applies head IK after other IKs. Temporary solution for now
    /// has to be done properly. Also shoulders should be added.
    /// </summary>
    public class CustomFBBIKHeadEffector : MonoBehaviour {
